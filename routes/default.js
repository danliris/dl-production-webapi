...
let orderStatusHistoryRouter = require('../src/routers/v1/sales/order-status-history-router');
...
module.exports = function(server) {
    ...
    orderStatusHistoryRouter().applyRoutes(server,                              "/sales/order-status-histories")
};